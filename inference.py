...
def get_rnpd(impath):
    ...
    p = subprocess.Popen(["./darknet", "detector", "test", "cfg/obj.data", "cfg/yolo-obj.cfg", "yolo-obj.weights -dont_show", impath], stdout=subprocess.PIPE)
    p.communicate()
    ...
    save_path="/home/cogknit/experiments/dataset/900_dataset_crop"+os.path.split(impath)[-1]
...
#             image_list=f.read().split('\n')
        image_list=glob.glob("/home/cogknit/experiments/dataset/clean_900_dataset/*.jpg")
        count=0
